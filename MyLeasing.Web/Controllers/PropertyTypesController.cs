...
namespace MyLeasing.Web.Controllers
{
    public class PropertyTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] PropertyType propertyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] PropertyType propertyType)
        {
