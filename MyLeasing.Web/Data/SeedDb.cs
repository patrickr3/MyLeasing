...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Juan", "Zuluaga", "patrickr3@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "Juan", "Zuluaga", "patrickr3@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("3030", "Juan", "Zuluaga", "patrickr3@outlook.com", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
        ...
        private async Task CheckContractsAsync()
        {
            ...
            if (!_context.Contracts.Any())
            {
                _context.Contracts.Add(new Contract
                {
                    ...
                    "Nullam gravida nunc eleifend, placerat tellus a, eleifend metus. Phasellus idsuscipit magna. " +
                    "Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. " + 
                    "Nullam volutpat ultrices ex, sed cursus sem tincidunt ut. Nullam metus lorem, convallis quis " +
                    "dignissim quis, porttitor quis leo. In hac habitasse platea dictumst. Duis pharetra sed arcu ac viverra. " +
                    "Proin dapibus lobortis commodo. Vivamus non commodo est, ac vehicula augue. Nam enim felis, rutrum in tortor sit amet, " +
                    "efficitur hendrerit augue. Cras pellentesque nisl eu maximus tempor. Curabitur eu efficitur metus. Sed ultricies urna et auctor commodo."
        ...
        private async Task CheckPropertyTypesAsync()
        {
            if (!_context.PropertyTypes.Any())
            {
                ...
                _context.PropertyTypes.Add(new Entities.PropertyType { Name = "Local Comercial" });
                await _context.SaveChangesAsync();
            }
        }
